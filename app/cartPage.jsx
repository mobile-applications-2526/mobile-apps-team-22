...
const CartPage = () => {
  ...
  const handleCheckout = () => {
      ...
      Alert.alert(
        ...
        [
          ...
          { 
            ...
            onPress: () => {
              // Redirect to Login, passing a param so we know to come back
              router.push({
                pathname: '/login', // Make sure this path is correct for your auth folder
    ...
    // C. If Logged In -> Proceed to Payment/Order
    console.log("User is logged in. Proceeding to payment...");
    // router.push('/checkout'); // Your next step
  };
