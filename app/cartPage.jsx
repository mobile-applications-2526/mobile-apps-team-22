...
//   // --- NEW HANDLER FOR CHANGING LOCATION ---
//   const handleChangeLocation = () => {
//     router.push({
//       pathname: '/locationSelectionPage', // Ensure this matches your file name exactly
//       params: { fromCart: 'true' } // 🚩 Signal that we are coming from the cart
//     });
//   };
...
//         {/* 1. Location Header - MADE CLICKABLE */}
//         <View style={tw`flex-row justify-between items-start mb-8`}>
          
//           {/* Wrapped Left Side in TouchableOpacity */}
//           <TouchableOpacity 
//             onPress={handleChangeLocation} 
//             style={tw`flex-1 mr-4 active:opacity-60`}
//           >
//             <View style={tw`flex-row items-center`}>
//               <Text style={tw`text-lg font-bold text-black mr-1`}>Pickup Order at:</Text>
//               {/* Visual cue that this is editable */}
//               <Text style={tw`text-[#E1503F] font-bold text-lg`}>Change</Text>
//             </View>
